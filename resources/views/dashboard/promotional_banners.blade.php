...
@section('title')
    <title>Promotional Banner - Zaman's Laptop</title>
@endsection
        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0">Promotional Banners</h3>
                </div>
            </div>
        </div> <!-- Row end  -->
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header text-center">
                        <h5 class="m-0 mt-2">Add Banner</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('promotional_banner.add') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="single-banner col-md-6 col-sm-4 mb-3">
                                <div class="card h-100">
                                    <div class="img_box p-3">
                                        <img class="card-img-top" src="{{ asset('dashboard_assets/images/promo_banner') }}/{{ $item->image }}" alt="Banner Image {{ $key+1 }}" />
                                    </div>
                                    <div class="card-body">
                                        <div class="title-del-btn d-flex justify-content-between align-items-center mb-3">
                                            <h5 class="card-title">Banner {{ $key+1 }}</h5>
                                            <a href="{{ route('promotional_banner.delete',encrypt($item->id)) }}" class="btn btn-outline-secondary deleterow banner-delete-btn opacity-0 invisible"><i class="icofont-ui-delete text-danger"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
