...
@section('title')
    <title>Product Inventory - Zaman's Laptop</title>
@endsection
            ...
            <div class="row align-items-center">
                <div class="border-0 mb-4">
                    <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                        <h3 class="fw-bold mb-0">Inventory List</h3>
                    </div>
                </div>
            </div> <!-- Row end  -->
                                    ...
                                    <tbody>
                                        @foreach ($data as $key=>$item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('product.details', $item->product_code) }}">{{ Str::limit($item->title, 15 , '...') }}</a>
                                                </td>
