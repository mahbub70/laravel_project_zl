...
@section('title')
    <title>Brands - Zaman's Laptop</title>
@endsection
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header text-center">
                        <h5 class="m-0 mt-2">Add New Brand</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('brand.add') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="image-upload">
                                <div class="single-item mb-2 text-center" id="upload_box">
                                    ...
                                    <div class="mt-2">Upload Brand Image</div>
                            ...
                            <div class="single-banner col-md-6 col-sm-4 mb-3">
                                <div class="card h-100">
                                    <div class="img_box p-3">
                                        <img class="card-img-top" src="{{ asset('dashboard_assets/images/brand') }}/{{ $item->image }}" alt="Brand Image {{ $key+1 }}" />
                                    </div>
                                    <div class="card-body">
                                        <div class="title-del-btn d-flex justify-content-between align-items-center mb-3">
                                            <h5 class="card-title">Brand {{ $key+1 }}</h5>
                                            <a href="{{ route('brand.delete',encrypt($item->id)) }}" class="btn btn-outline-secondary deleterow banner-delete-btn opacity-0 invisible"><i class="icofont-ui-delete text-danger"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
